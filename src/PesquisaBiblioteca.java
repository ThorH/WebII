 ...
 */
@WebServlet("/PesquisaBiblioteca")
public class PesquisaBiblioteca extends HttpServlet {
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		bibDAO.pesquisarBiblioteca(bib);
				...
				+"<body>"
					+"<div id='interface' >"
						...
						+"<header id='cabecalho'>"
							...
							+"</hgroup>"	
						+"</header>"			
						+"<h1>ID: "+bib.getId()+" - Nome: "+bib.getNome()+" - Endereço: "+bib.getEndereco()+"</h1>"
						+"<footer id='rodape'>"
